...
<head>
    ...
    <title>EGUIDANCE - Student Dashboard</title>
        ...
        createApp({
            ...
            methods: {
                ...
                async loadDashboardData() {
                    try {
                        // Load appointments (placeholder data for now)
                        this.appointments = [
                            {
                                id: 1,
                        ...
                        this.stats.completedAppointments = this.appointments.filter(a => a.status === 'completed').length;
                        this.stats.pendingAppointments = this.appointments.filter(a => a.status === 'pending').length;
                        this.stats.upcomingAppointments = this.appointments.filter(a => a.status === 'approved').length;
                    } catch (error) {
